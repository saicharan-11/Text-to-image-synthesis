# -*- coding: utf-8 -*-
"""
Created on Tue May 25 23:13:00 2021
...
path_to_models = r'C:\Users\pinup\DL_Project'
path_to_tables = r'C:\Users\pinup\DL_Project'
#-----------------------------------------------------------------------------#

path_to_umodel = path_to_models + r'/uni_skip.npz'
path_to_bmodel = path_to_models + r'/bi_skip.npz'
...
def load_tables():
    ...
    """
    words = []
    utable = numpy.load(path_to_tables + r'\utable.npy', encoding='latin1',allow_pickle=True)
    btable = numpy.load(path_to_tables + r'\btable.npy', encoding='latin1',allow_pickle=True)
    f = open(path_to_tables + r'\dictionary.txt', 'rb')
    for line in f:
